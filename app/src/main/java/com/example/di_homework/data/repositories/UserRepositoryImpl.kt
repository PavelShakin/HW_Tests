...
class UserRepositoryImpl(private val remoteUsersServiceImpl: RemoteUserDataSourceImpl) : UserRepository {
    override suspend fun getUsersList(): List<UserDomain>? = remoteUsersServiceImpl.loadUsersList()
}